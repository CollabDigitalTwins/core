...
import type { BimToolProps, ModelIdMap } from '{{CORE_ENTRY}}'
...
// Everything here arrives as props. This component never imports `@thatopen/components` or
// three.js, which is what the boundary exists to enforce.
//
// The visibility step is the trap in this surface. `IFCSPACE` elements start hidden because
// they are volumetric and would obscure everything inside them, so listing spaces is not the
// same as showing them.
