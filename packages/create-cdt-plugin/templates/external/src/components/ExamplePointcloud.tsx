...
import type { PointCloudToolProps, ToolbarToolProps } from '{{SURFACE_ENTRY}}'

/**
 * `viewer` is `unknown` on purpose: Potree publishes no types, and handing you a fabricated
 * interface would be worse than making you narrow it.
 *
 * This is the narrowing. Check for the member you are about to use, then use it. `ready`
 * says Potree has finished initialising; it is not a substitute for the check, because it
 * tells you nothing about the shape of what you were handed.
 */
